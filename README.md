# Salt Extension for Btrfs

Salt Extension for interacting with btrfs
...
The saltext-btrfs project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-btrfs.git
...
* Writing blog posts
* Sharing your experiences using Salt + Btrfs
  on social media
...
[PRs]: https://github.com/salt-extensions/saltext-btrfs/pulls
[discussions]: https://github.com/salt-extensions/saltext-btrfs/discussions
